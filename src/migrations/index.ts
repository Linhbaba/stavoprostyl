...
import * as migration_20250616_footer_links from './20250616_footer_links'
...
export const migrations = [
  ...
  { up: migration_20250616_footer_links.up, down: migration_20250616_footer_links.down, name: '20250616_footer_links' },
]
